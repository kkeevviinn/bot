...
module.exports.run = async(bot, message, args) => {
    ...
    {
        if(!(message.channel.name === 'jcrp-applications' || message.guild.name === 'JusticeCommunityRP - Development'))
        {
            try {
        ...
        else
        {
            ...
            else
            {
                ...
                .setAuthor("Want to be apart of Law Enforcement? First Responders? Communications?")
                .setDescription("\n" + announcement)
