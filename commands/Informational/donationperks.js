...
module.exports.run = async(bot, message, args) => {
    ...
    {
        if(!(message.channel.name === 'jcrp-donations' || message.channel.name === '_test' || message.guild.name === 'JusticeCommunityRP - Development'))
        {
            try {
        ...
        else
        {
            ...
            else
            {
                ...
                .setAuthor("Justice Community Roleplay Server Donations - Perks")
                .setDescription("\n" + announcement)
