...
module.exports.run = async(bot, message, args) => {
    ...
    {
        if(!(message.channel.name === 'jcrp-donations_vehicles' || message.channel.name === '_test' || message.guild.name === 'JusticeCommunityRP - Development'))
        {
            try {
        ...
        else
        {
            ...
            else
            {
                ...
                .setAuthor("Justice Community Roleplay Server Donations - Vehicle List")
                .setDescription("\n" + announcement)
